  ...
  return (
    <section className="relative h-screen w-full overflow-hidden pt-4 text-white">
      <div className="relative flex h-full w-full items-center justify-center">
        ...
        <div
          className={cn('participants-list h-[calc(100vh-86px)] hidden ml-2', {
      ...
      <div className="fixed bottom-0 flex w-full flex-wrap items-center justify-center gap-3 px-4 py-3 sm:gap-5 sm:px-6">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="border-dark-1 bg-dark-1 text-white sm:w-[200px]">
